...
```hcl
github.com/pbs/terraform-aws-lambda-cron-module?ref=0.1.12
```
...
```hcl
module "lambda-cron" {
  source = "github.com/pbs/terraform-aws-lambda-cron-module?ref=0.1.12"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lambda"></a> [lambda](#module\_lambda) | github.com/pbs/terraform-aws-lambda-module | 1.3.6 |

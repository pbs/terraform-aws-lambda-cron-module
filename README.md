...
```hcl
github.com/pbs/terraform-aws-lambda-cron-module?ref=0.1.15
```
...
```hcl
module "lambda-cron" {
  source = "github.com/pbs/terraform-aws-lambda-cron-module?ref=0.1.15"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_lambda"></a> [lambda](#module\_lambda) | github.com/pbs/terraform-aws-lambda-module | 1.3.13 |
